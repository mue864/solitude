    ...
    <View className="flex-1 bg-primary pb-20">
      ...
      <View className="flex-1">
        ...
        <View className="flex-1 items-center px-4">
          {/* Disappearing UI Container */}
          <View
            className="w-full"
            onLayout={(e) =>
              setDisappearingUIHeight(e.nativeEvent.layout.height)
            }
          >
          ...
          <View className="flex-1 justify-center mt-10 items-center w-full">
          ...
          {!currentFlowId && !isRunning && !isPaused && (
            <Animated.View
              style={{
                ...
                transform: [
                  { scale: todayProgressAnim },
                  { translateY: todayProgressTranslateY },
                ],
              }}
            >
              <TodayProgress />
